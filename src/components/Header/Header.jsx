  ...
  return (
    <header className="text-white bg-[#525AA0] rounded-[15px] md:mx-[70px]">
      <section className="py-[1em] flex flex-col items-center justify-around lg:justify-between lg:flex-row lg:py-0">
        ...
        <nav className={`${!open ? 'hidden' : 'flex'} w-full items-center font-[500] cursor-pointer lg:flex lg:w-[37%]`}>
        ...
        <div className={`${!open ? 'hidden' : 'flex'} flex-col h-full w-[50%] justify-around font-[500] text-[0.875rem] lg:flex lg:flex-row lg:w-[15%]`}>
          <button className="capitalize py-2">login</button>
          <button className="bg-white rounded-[16px] text-black h-full capitalize py-2 w-full lg:w-fit lg:px-4">join now</button>
        </div>
      </section>
    </header> 
  );
